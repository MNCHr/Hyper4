...
control do_remove_header_61 {
  apply(t_removeh_61);
}

control do_remove_header_62 {
  apply(t_removeh_62);
}

control do_remove_header_63 {
  apply(t_removeh_63);
}

control do_remove_header_64 {
  apply(t_removeh_64);
}

control do_remove_header_65 {
  apply(t_removeh_65);
}

control do_remove_header_66 {
  apply(t_removeh_66);
}

control do_remove_header_67 {
  apply(t_removeh_67);
}

control do_remove_header_68 {
  apply(t_removeh_68);
}

control do_remove_header_69 {
  apply(t_removeh_69);
}

control do_remove_header_71 {
  apply(t_removeh_71);
}

control do_remove_header_72 {
  apply(t_removeh_72);
}

control do_remove_header_73 {
  apply(t_removeh_73);
}

control do_remove_header_74 {
  apply(t_removeh_74);
}

control do_remove_header_75 {
  apply(t_removeh_75);
}

control do_remove_header_76 {
  apply(t_removeh_76);
}

control do_remove_header_77 {
  apply(t_removeh_77);
}

control do_remove_header_78 {
  apply(t_removeh_78);
}

control do_remove_header_79 {
  apply(t_removeh_79);
}
